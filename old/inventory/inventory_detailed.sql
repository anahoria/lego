with aux1 as (
	...
	select
		...
		fig_num as set_num,
		null as set_qtty_in_kit,
		fig_name as set_name,
		null as set_year,
		null as set_theme_id,
		null as set_theme_name,
		fig_num_parts as set_num_parts,
		fig_img_url as set_img_url
	from
...
source_data as (
	...
	select
		...
		t3.color_group as set_part_color_group_name,
		t3.group_rgb as set_part_color_group_rgb,
	...
	on 
		t1.set_id = t2.inventory_id
	left join 
		{{ source("main", "color_simplified") }} t3
	on 
		t2.color_id = t3.id
)
